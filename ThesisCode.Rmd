...
str(Filtered) #18,000 fixes left
```
...
```{r}
grid.arrange(LoadingPlot_1hour, LoadingPlot_3hour, LoadingPlot_1day, nrow = 3)
grid.arrange(ScorePlot_1hour_ME, ScorePlot_3hour_ME, ScorePlot_1day_ME, nrow = 2)
grid.arrange(ScorePlot_1hour_Ind, ScorePlot_3hour_Ind, ScorePlot_1day_Ind, nrow = 2)
grid.arrange(ScorePlot_1hour_Region, ScorePlot_3hour_Region, ScorePlot_1day_Region, nrow = 2)
```
...
dispersions_Ind<-TukeyHSD(mod_Ind)
dispersions_m_Ind<-tukey_to_matrix(dispersions_Ind$group) #make into a matrix for corrplot
dispersions_m_Ind[is.na(dispersions_m_Ind)]<- 1
dispersions_m_Ind_t<-t(dispersions_m_Ind)
dispersions_m_Ind_t[is.na(dispersions_m_Ind_t)]<- 1
dispersions_Ind_1hr<-dispersions_m_Ind*dispersions_m_Ind_t
...
Heatmap(dispersions_Ind_1hr, name = "p-value", 
        ...
        rect_gp = gpar(col = "grey80", lwd = 0.5),
        heatmap_legend_param = list(legend_height = unit(12, "cm"))) #export size is 1500 x 1160
#Edwin and Donovan differ from most other birds. Interesting that NFB and Belle don't differ even though they had differing migration events. 
```
...
dispersions_Ind3<-TukeyHSD(mod_Ind_3)
dispersions_m_Ind3<-tukey_to_matrix(dispersions_Ind3$group) #make into a matrix for corrplot
dispersions_m_Ind3[is.na(dispersions_m_Ind3)]<- 1
dispersions_m_Ind_t3<-t(dispersions_m_Ind3)
dispersions_m_Ind_t3[is.na(dispersions_m_Ind_t3)]<- 1
dispersions_Ind_3hr<-dispersions_m_Ind3*dispersions_m_Ind_t3
...
Heatmap(dispersions_event_3hr, name = "p-value", 
        ...
        color_space = c(0,1),
        rect_gp = gpar(col = "grey80", lwd = 0.5),
        heatmap_legend_param = list(legend_height = unit(12, "cm"))) #NFB and Belle have the most differences, followed by Sr. Bones, then Donovan 2014.  

Heatmap(dispersions_Ind_3hr, name = "p-value", 
        row_names_gp = gpar(fontsize = 10),
        column_names_gp= gpar(fontsize = 10),
        cluster_rows = F,
        cluster_columns = F,
        ...
        color_space = c(0,1),
        rect_gp = gpar(col = "grey80", lwd = 0.5),
        heatmap_legend_param = list(legend_height = unit(12, "cm"))) #Belle, Donovan, Sr. Bones have the most differences. 
```
