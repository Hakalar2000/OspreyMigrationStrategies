...
library(pairwiseAdonis) #post-hoc multilevel comparison test
library(MicEco) #omega-squared values
library(biostat) #CLD groupings
...
> Scale/normalize data for PERMANOVA
...
> Between Individuals...Did not take a subsample for each individual
