...
for (i in 1:142) {
  ...
  fpt_max_1hour<-rbind(fpt_max, fpt)
}
...
IndividualMetadata<-merge(Latitude, IndividualMetadata, by = "migrationEvent")
...
str(OSPR_1hour_summary)
OSPR_1hour_summary<-OSPR_1hour_summary[ ,c("trackId", "ID", "FirstDate", "duration", "total_dist", "migrate_speed", "mean_turn_speed", "mean_absolute", "sinuosity", "fpt", "Multiple", "Study", "Migration Year", "Flyway", "Status", "Year Born", "Sex", "Age", "max(location_lat).x")] 
...
names(OSPR_1hour_summary) [names(OSPR_1hour_summary) == "max(location_lat).x"] <- "Start_Lat"
...
OSPR_3hour_summary<-OSPR_3hour_summary[ ,c("trackId", "ID", "FirstDate", "duration", "total_dist", "migrate_speed", "mean_turn_speed", "mean_absolute", "sinuosity", "fpt", "Multiple", "Study", "Migration Year", "Flyway", "Status", "Year Born", "Sex", "Age", "max(location_lat).x")] 
...
names(OSPR_3hour_summary) [names(OSPR_3hour_summary) == "max(location_lat).x"] <- "Start_Lat"
...
OSPR_1day_summary<-OSPR_1day_summary[ ,c("trackId", "ID", "FirstDate", "duration", "total_dist", "migrate_speed", "mean_turn_speed", "mean_absolute", "sinuosity", "fpt", "Multiple", "Study", "Migration Year", "Flyway", "Status", "Year Born", "Sex", "Age", "max(location_lat).x")] 
...
names(OSPR_1day_summary) [names(OSPR_1day_summary) == "max(location_lat).x"] <- "Start_Lat"
...
OSPR_3day_summary<-OSPR_3day_summary[ ,c("trackId", "ID", "FirstDate", "duration", "total_dist", "migrate_speed", "mean_turn_speed", "mean_absolute", "sinuosity", "fpt", "Multiple", "Study", "Migration Year", "Flyway", "Status", "Year Born", "Sex", "Age", "max(location_lat).x")] 
...
names(OSPR_3day_summary) [names(OSPR_3day_summary) == "max(location_lat).x"] <- "Start_Lat"
...
#Dendrogram
OSPR_1hour_clust<-hclust(dist(OSPR_1hour_norm), method = "ward.D2")
OSPR_1hour_clust<-as.dendrogram(OSPR_1hour_clust)
labels(OSPR_1hour_clust)<-OSPR_1hour_summary$trackId
OSPR_1hour_clust <- set(OSPR_1hour_clust, "labels_cex", 0.2)

#color_Sex <- transform(OSPR_1hour_summary,# Create ID by group: color = as.numeric(factor(Sex)))
#colors_to_use <- as.numeric(color_Sex$color)
# Sort them based on their order in dend:
#colors_to_use <- colors_to_use[order.dendrogram(OSPR_1hour_clust)]
#labels_colors(OSPR_1hour_clust) <- colors_to_use
#dend.list<-as.character(OSPR_1hour_summary$Sex)
#labels(OSPR_1hour_clust)<- dend.list[order.dendrogram(OSPR_1hour_clust)]
plot(OSPR_1hour_clust, main = "1 hour sampling interval")

#optimal clusters
NbClust(OSPR_1hour_norm, method = "ward.D2", index = "all")$Best.nc # 4 clusters
```
...
OSPR_3hour_clust<-as.dendrogram(OSPR_3hour_clust)
labels(OSPR_3hour_clust)<-OSPR_3hour_summary$trackId
OSPR_3hour_clust <- set(OSPR_3hour_clust, "labels_cex", 0.2)
plot(OSPR_3hour_clust, main = "1 hour sampling interval")
...
OSPR_1day_clust<-as.dendrogram(OSPR_1day_clust)
labels(OSPR_1day_clust)<-OSPR_1day_summary$trackId
OSPR_1day_clust <- set(OSPR_1day_clust, "labels_cex", 0.2)
plot(OSPR_1day_clust, main = "1 hour sampling interval")

#optimal clusters
NbClust(OSPR_1day_norm, method = "ward.D2", index = "all")$Best.nc # 2 or 3 clusters
```
...
OSPR_3day_clust<-as.dendrogram(OSPR_3day_clust)
labels(OSPR_3day_clust)<-OSPR_3day_summary$trackId
OSPR_3day_clust <- set(OSPR_3day_clust, "labels_cex", 0.2)
plot(OSPR_3day_clust, main = "1 hour sampling interval")
NbClust(OSPR_3day_norm, method = "ward.D2", index = "all")$Best.nc # 4 clusters
```
